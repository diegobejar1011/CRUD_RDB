...
export const updateColor = (newObject) => {
    return new Promise((resolve, reject)=>{
        ...
        const query = 'UPDATE color set codigo_color = ?, updated_at = ? WHERE id_color=?';
...
export const postColorProducto = (newObject) => {
    return new Promise ((resolve, reject) => {
        ...
        const query = 'INSERT INTO producto_color (id_producto,id_color, created_at) VALUES (?,?,?)';
...
export const postColorPedido = (newObject) => {
    return new Promise((resolve, reject)=>{
        ...
        const query = 'INSERT INTO pedido_color (id_pedido, id_color, created_at) VALUES (?,?,?)';
